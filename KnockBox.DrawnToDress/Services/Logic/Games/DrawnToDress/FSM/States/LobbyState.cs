...
{
    /// <summary>
    /// Initial state: the game is waiting for the host to start.
    /// No commands are accepted here (game start is handled by the engine's StartAsync).
    /// Transitions to <see cref="DrawingState"/> on game start.
    /// </summary>
