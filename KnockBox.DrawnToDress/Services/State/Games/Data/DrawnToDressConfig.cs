namespace KnockBox.DrawnToDress.Services.State.Games.Data
{
    public class DrawnToDressConfig
    {
        ...
        [
            ...
            new() { Id = "top",        DisplayName = "Top",       AllowMultiple = false, CanvasWidth = 600, CanvasHeight = 450, MannequinAnchorY = 700 },
            new() { Id = "bottom",     DisplayName = "Bottom",    AllowMultiple = false, CanvasWidth = 600, CanvasHeight = 450, MannequinAnchorY = 1080 },
            new() { Id = "shoes",      DisplayName = "Shoes",     AllowMultiple = false, CanvasWidth = 600, CanvasHeight = 350, MannequinAnchorY = 1270 },
        ];
