...
using KnockBox.Codeword.Services.Logic.Games.Data;
...
namespace KnockBox.Codeword.Services.Logic.Games.FSM
{
    ...
    /// Created when the game starts and stored on <see cref="CodewordGameState.Context"/>.
    /// </summary>
    public class CodewordGameContext(
        ...
        ILogger logger)
    {
        ...
        public List<CodewordPlayerState> GetAlivePlayers()
