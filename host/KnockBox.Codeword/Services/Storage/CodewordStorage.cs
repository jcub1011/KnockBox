...
{
    /// <summary>
    /// Route-scoped client storage for Codeword. Wrapping the shared
    ...
    /// </summary>
    public sealed class CodewordStorage
    {
        public CodewordStorage(IPluginContext context, ILocalStorageService localStorage)
        {
