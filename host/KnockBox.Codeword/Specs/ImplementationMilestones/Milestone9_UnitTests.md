...
- Standard `[TestInitialize]`: Mock `IRandomNumberService`, `ILogger`, create host `User`, create `CodewordGameState`, create `CodewordGameContext`
- Helper methods:
...
### 9.2 CodewordGameContextTests.cs
...
### 9.3 CodewordGameEngineTests.cs
...
### 9.4 CodewordGameEnginePlayerLeftTests.cs
