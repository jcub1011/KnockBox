...
### 3.1 Commands (`CodewordCommand.cs`)
...
### 3.2 Type Aliases (`ICodewordGameState.cs`)
...
### 3.3 Context (`CodewordGameContext.cs`)
...
## Acceptance Criteria
- [ ] All 7 command types compile and inherit from `CodewordCommand`
- [ ] Type aliases correctly reference the generic state machine interfaces
- [ ] `CodewordGameContext` has all required references and helper methods
