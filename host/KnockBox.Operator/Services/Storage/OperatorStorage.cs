...
{
    /// <summary>
    /// Route-scoped client storage for Operator. Wrapping the shared localStorage
    ...
    /// </summary>
    public sealed class OperatorStorage
    {
        public OperatorStorage(IPluginContext context, ILocalStorageService localStorage)
        {
