namespace KnockBox.AlphaChain.Services.Logic.Games.FSM
{
    ...
    /// </summary>
    public abstract record AlphaChainCommand(Guid ActorUserId);

    /// <summary>Rotates the active player to the next seat in turn order.</summary>
    public record AdvanceTurnCommand(Guid ActorUserId) : AlphaChainCommand(ActorUserId);
    ...
    /// </summary>
    public record SkipTutorialCommand(Guid ActorUserId) : AlphaChainCommand(ActorUserId);
}
