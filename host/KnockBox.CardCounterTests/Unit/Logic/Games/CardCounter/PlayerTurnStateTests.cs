...
namespace KnockBox.CardCounter.Tests.Unit.Logic.Games.CardCounter
{
    ...
    public class PlayerTurnStateTests
    {
        ...
        public void DrawCard_NumberCard_AppendsDigitToActivePot()
        {
            ...
            fsmState.HandleCommand(_context, new DrawCardCommand(p1.PlayerId));
        ...
        public void DrawCard_WhenShoeIsEmpty_IsNoOp()
        {
            ...
            var fsmState = new PlayerTurnState();
            fsmState.OnEnter(_context);
            var result = fsmState.HandleCommand(_context, new DrawCardCommand(p1.PlayerId));
        ...
        public void DrawCard_WhenNotActivePlayer_IsNoOp()
        {
            ...
            var fsmState = new PlayerTurnState();
            fsmState.OnEnter(_context);
            fsmState.HandleCommand(_context, new DrawCardCommand(p2.PlayerId)); // p2 tries to draw
        ...
        public void PlayActionCard_WhenNotActivePlayer_IsNoOp()
        {
            ...
            var fsmState = new PlayerTurnState();
            fsmState.OnEnter(_context);
            var next = fsmState.HandleCommand(_context, new PlayActionCardCommand(p2.PlayerId, 0));
        ...
        public void PlayActionCard_CompdCannotBePlayedDirectly()
        {
            ...
            var fsmState = new PlayerTurnState();
            fsmState.OnEnter(_context);
            var next = fsmState.HandleCommand(_context, new PlayActionCardCommand(p1.PlayerId, 0));
        ...
        public void PlayActionCard_InvalidCardIndex_IsNoOp()
        {
            ...
            var fsmState = new PlayerTurnState();
            fsmState.OnEnter(_context);
            var next = fsmState.HandleCommand(_context, new PlayActionCardCommand(p1.PlayerId, 99));
        ...
        public void PlayActionCard_Burn_RemovesTopCardFromShoe()
        {
            ...
            var fsmState = new PlayerTurnState();
            fsmState.OnEnter(_context);
            fsmState.HandleCommand(_context, new PlayActionCardCommand(p1.PlayerId, 0));
        ...
        public void PlayActionCard_TurnTheTable_OnOtherPlayer_EntersWaitingForReactionState()
        {
            ...
            var fsmState = new PlayerTurnState();
            fsmState.OnEnter(_context);
            var next = fsmState.HandleCommand(_context, new PlayActionCardCommand(p1.PlayerId, 0, TargetPlayerId: p2.PlayerId));
        ...
        public void PlayActionCard_TurnTheTable_OnSelf_ReversesPotImmediately()
        {
            ...
            var fsmState = new PlayerTurnState();
            fsmState.OnEnter(_context);
            fsmState.HandleCommand(_context, new PlayActionCardCommand(p1.PlayerId, 0, TargetPlayerId: p1.PlayerId));
        ...
        public void PlayActionCard_Launder_OnSelf_IsNoOpAndAdvancesToPlayerTurnState()
        {
            ...
            var fsmState = new PlayerTurnState();
            fsmState.OnEnter(_context);
            var next = fsmState.HandleCommand(_context, new PlayActionCardCommand(p1.PlayerId, 0, TargetPlayerId: p1.PlayerId));
        ...
        public void PlayActionCard_Burn_RecordsLastPlayedAction()
        {
            ...
            Assert.AreEqual(p1.PlayerId, _state.LastPlayedAction.PlayerId);
        }
        ...
        {
            _state.PendingReaction = new PendingReactionInfo(Guid.NewGuid(), "src", Guid.NewGuid(), new ActionCard(ActionType.TurnTheTable));
            _state.FeelingLuckyTargetId = Guid.NewGuid();
        ...
        public void PlayActionCard_HedgeYourBet_WhenShoeNotEmpty_SetsHedgeFlag()
        {
            ...
            Assert.AreEqual(p1.PlayerId, _state.HedgeYourBetPlayerId, "HedgeYourBetPlayerId should be set to the playing player.");
        ...
        public void HedgeYourBet_WhenBalanceNegative_NextDrawBecomesAddOperator()
        {
            ...
            _state.HedgeYourBetPlayerId = p1.PlayerId;
        ...
        public void HedgeYourBet_OnlyAffectsNextDraw_ClearedAfterOneDraw()
        {
            ...
            fsmState2.HandleCommand(_context, new DrawCardCommand(p2.PlayerId));
        ...
        public void LetItRide_TwoExtraTurns_PlayerPlaysTwiceMoreBeforeAdvancing()
        {
            ...
            var fsmState2 = new PlayerTurnState();
            fsmState2.OnEnter(_context);
            fsmState2.HandleCommand(_context, new DrawCardCommand(p1.PlayerId));
            ...
            fsmState3.HandleCommand(_context, new DrawCardCommand(p1.PlayerId));
