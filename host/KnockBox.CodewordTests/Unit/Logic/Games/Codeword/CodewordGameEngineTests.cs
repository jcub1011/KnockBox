...
{
    /// <summary>
    /// Tests for <see cref="CodewordGameEngine"/> public-facing API methods,
    /// covering lifecycle, UI command routing, and player-leave handling.
    /// </summary>
    [TestClass]
    public class CodewordGameEngineTests
    {
        ...
        public async Task CreateStateAsync_WithValidHost_ReturnsState()
        {
            ...
            Assert.IsInstanceOfType(result.Value, typeof(CodewordGameState));
        }
        ...
        public async Task HandlePlayerLeft_DuringVotePhase_VoidsVotesForDisconnectedPlayer()
        {
            ...
            state.SetPhase(CodewordGamePhase.Voting);
