...
{
    /// <summary>
    /// Route-scoped client storage for Drawn To Dress. Wrapping the shared
    ...
    /// </summary>
    public sealed class DrawnToDressStorage
    {
        public DrawnToDressStorage(IPluginContext context, ILocalStorageService localStorage)
        {
