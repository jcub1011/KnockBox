...
{
    /// <summary>
    /// Route-scoped client storage for Linked List. Wrapping the shared
    ...
    /// </summary>
    public sealed class LinkedListStorage
    {
        public LinkedListStorage(IPluginContext context, ILocalStorageService localStorage)
        {
